...
const PaymentTermsAndCondition = () => {
    return (
        <>
            <Head>
                <title>Payment Terms and Condition | Indian Journal of Physical Therapy</title>
                <meta charset="utf-8"></meta>
                <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0, maximum-scale=1.0" />

                <meta name="viewport" content="width=device-width, initial-scale=1" />
                <meta name='keywords' content='IJOPT, Indian Journal of Physical Therapy, Indian Journal of Physiotherapy, Open Access Journal, Physiotherapy Journal, Physical Therapy Journal, International Journal for Physiotherapy, PhysioZine, Payment Terms and Conditions of IJOPT' />
                ...
                <meta property="og:title" content="Payment Terms and Conditions of IJPOT" />
                ...
                <meta property="og:url" content="https://ijopt.vercel.app/policy/payment-terms-and-condition" />
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "url": "https://ijopt.vercel.app/policy/payment-terms-and-condition",
                        ...
                        "keywords": ["Physiotherapy Journal", "Open Access", "Research Articles", "Physical Therapy", "Payment Terms and Conditions of IJOPT", "Terms and Conditions of Payment in IJOPT"],
                        "potentialAction": [
                            {
                                "@type": "ReadAction",
